...
**方式1: 直接传入数组（推荐）**
```typescript
import { configureMenus } from '@jh-app/app'
...
**方式2: 增量添加**
```typescript
import { addMenuGroup, addMenuItem } from '@jh-app/app'
...
**完全自定义菜单**
```typescript
import { setMenuConfig } from '@jh-app/app'
...
```typescript
// 可以使用更多功能，但不是必须的
import { setMenuConfig, addMenuItem } from '@jh-app/app'
