<template>
  <view class="h-100% w-100% position-relative">
    <view
      id="bpmnCanvas"
      class="process-viewer w-100% h-100%"
      :prop="actualXml"
      :change:prop="bpmnCanvas.handleXmlChange"
      :view-prop="actualView"
      :change:view-prop="bpmnCanvas.handleViewChange"
...
// renderjs 模块引用声明（实际由 UniApp renderjs 运行时注入）
const bpmnCanvas = ref<any>(null) // eslint-disable-line
