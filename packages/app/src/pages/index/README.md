...
<script setup>
import { UserHeader, MenuSection, HomeNews } from '@jinghe-sanjiaoroad-app/framework/pages/index'
</script>
```
...
```typescript
// App.vue - 应用启动时
import { configureMenus } from '@jinghe-sanjiaoroad-app/framework/pages/index'
...
```typescript
import { addMenuGroup, addMenuItem } from '@jinghe-sanjiaoroad-app/framework/pages/index'
...
```typescript
import { setMenuConfig } from '@jinghe-sanjiaoroad-app/framework/pages/index'
...
import { 
  ...
  getMenuStats           // 获取菜单统计
} from '@jinghe-sanjiaoroad-app/framework/pages/index'
...
```typescript
// 按需添加功能
import { addMenuItem } from '@jinghe-sanjiaoroad-app/framework/pages/index'
...
```typescript
// 完全控制
import { setMenuConfig, type MenuConfig } from '@jinghe-sanjiaoroad-app/framework/pages/index'
...
```typescript
import { getMenuStats, resetMenuConfig } from '@jinghe-sanjiaoroad-app/framework/pages/index'
