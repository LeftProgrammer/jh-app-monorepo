...
const props = withDefaults(defineProps<{
  ...
  profileUrl: '/pages-core/user/profile/index',
  securityUrl: '/pages-core/user/security/index',
  feedbackUrl: '/pages-core/user/feedback/index',
  settingsUrl: '/pages-core/user/settings/index',
})
...
const deptName = computed(() => {
  return userProfile.value?.dept?.name || '暂无部门'
})
...
function handleGoProfile() {
  uni.navigateTo({ url: props.profileUrl })
}

/** 跳转到账号安全 */
function handleGoSecurity() {
  uni.navigateTo({ url: props.securityUrl })
}

/** 跳转到意见反馈 */
function handleGoFeedback() {
  uni.navigateTo({ url: props.feedbackUrl })
}

/** 跳转到应用设置 */
function handleGoSettings() {
  uni.navigateTo({ url: props.settingsUrl })
}
