...
#### **基础使用**
```typescript
import { useTokenStore } from '@jinghe-sanjiaoroad-app/framework/store'
...
#### **基础使用**
```typescript
import { useUserStore } from '@jinghe-sanjiaoroad-app/framework/store'
...
#### **基础使用**
```typescript
import { useThemeStore } from '@jinghe-sanjiaoroad-app/framework/store'
...
#### **基础使用**
```typescript
import { useSystemState } from '@jinghe-sanjiaoroad-app/framework/store'
...
#### **基础使用**
```typescript
import { useGlobalState } from '@jinghe-sanjiaoroad-app/framework/store'
...
#### **基础使用**
```typescript
import { useDictStore } from '@jinghe-sanjiaoroad-app/framework/store'
