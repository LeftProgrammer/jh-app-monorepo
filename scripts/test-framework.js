...
console.log('  3. 运行 pnpm --filter @jinghe-sanjiaoroad-app/framework dev 开发一体化包');
console.log('  4. 运行 pnpm --filter @jinghe-sanjiaoroad-app/framework build 构建一体化包');
console.log('  5. 打开 examples/simple/index.html 测试基础功能');
console.log('\n🎯 一体化包优势:');
console.log('  ✅ 只需安装 @jinghe-sanjiaoroad-app/framework 一个依赖');
