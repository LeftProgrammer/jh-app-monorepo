  ...
  <view class="yd-page-container">
    ...
    >
      ...
      >
        ...
        <view>
          <view class="flex justify-between items-center text-27rpx gap-31rpx mb-19rpx">
...
import { getPage, deleteById } from "@/api/pms/document/received";
...
function routerTo(type: string, item?: any) {
  uni.navigateTo({
    url: `/pages/pms/document/owner/received/dataForm?type=${type}&menuType=2&id=${item?.id || ""}`
  });
}
